                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customers.update', $customer) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="full_name" name="full_name" class="form-control" value="{{ old('full_name', $customer->full_name) }}" >
                            @error('full_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ old('phone_number', $customer->phone_number) }}" maxlength="10">
                        ...
                        <div>
                            <button type="submit" id="submit-button" class="btn btn-success">Update Customer</button>
                        </div>
                    </form>
                </div>
            </div>
